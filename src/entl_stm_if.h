...
extern int entl_get_hello(entl_state_machine_t *mcn, uint16_t *emsg_raw, uint32_t *seqno);
extern int entl_next_send(entl_state_machine_t *mcn, uint16_t *emsg_raw, uint32_t *seqno); // ENTL_ACTION
extern int entl_next_send_tx(entl_state_machine_t *mcn, uint16_t *emsg_raw, uint32_t *seqno); // ENTL_ACTION
extern int entl_received(entl_state_machine_t *mcn, uint16_t from_hi, uint32_t from_lo, uint16_t emsg_raw, uint32_t seqno); // ENTL_ACTION
...
extern void entl_set_my_adder(entl_state_machine_t *mcn, uint16_t mac_hi, uint32_t mac_lo); 
